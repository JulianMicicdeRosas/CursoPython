...
creado haciendo uso de la función index buscando “Bootcamp”. Al obtener 
la posición, tener en cuenta la longitud de "Bootcamp Python 3" para extraerlo.
"""



textoCompleto = ("Estoy haciendo los ejercicios opcionales del curso Bootcamp Python 3 con el profesor Anartz Mugika")
