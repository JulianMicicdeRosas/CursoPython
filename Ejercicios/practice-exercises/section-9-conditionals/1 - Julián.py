...
numero_uno = input("Introducí el primer número: ")
numero_dos = input("Introducí el segundo número, dale: ")

if numero_uno == numero_dos:
    print("Son dos números iguales, bien.")
else:
    print("No son dos números iguales")