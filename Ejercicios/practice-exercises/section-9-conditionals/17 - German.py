...
if(mensaje.isupper()):
    print("Mensaje recibido. Se puso a gritar como loco.")

else:
    print("Mensaje recibido. No está gritando.")


"""
 #CON OPERADOR TERNARIO  
mensaje = input("Introduzca mensaje: ")
respuesta = print("Mensaje recibido. se puso a gritar como loco.") if(mensaje.isupper()) else print("Mensaje recibido.  no está gritando.")
"""
